const fs = require('fs');
let htmlFile = fs.readFileSync('public/ketbu_eval.html', 'utf8');

const anchor = 'html += `<h4 style="margin: 20px 0 10px 0; color:#3b82f6; font-size:15px;"><i class="fa-solid fa-clock-rotate-left"></i> Lịch sử đánh giá</h4>`;';
const insert = `
...
htmlFile = htmlFile.replace(anchor, insert + '\n' + anchor);
fs.writeFileSync('public/ketbu_eval.html', htmlFile, 'utf8');
console.log('Fixed ketbu_eval.html');
